# Educative - Learn Python 3 from Scratch - Data Types and Variables
...
* This notebook is only for the Data Types and Variables section, so move to the next assignment when you've completed that section.
